 ...
 */
public enum NumberOperator implements BitEnum {
    ...
    BI("位值in", DataOperator.BI.getValue()),
    BC("位值contain", DataOperator.BC.getValue());

    /**
     * 构造方法
     */
    NumberOperator(String text, long value) {
        this.text = text;
        this.value = value;
    }
